...
export declare type GeoJSONFeatureId = number | string;
...
export declare type PoolObject = {
	id: number;
	fbo: Framebuffer;
	texture: Texture;
	stamp: number;
 ...
 * });
 */
export declare type TransformStyleFunction = (previous: StyleSpecification, next: StyleSpecification) => StyleSpecification;
export declare type StyleSwapOptions = {
	diff?: boolean;
